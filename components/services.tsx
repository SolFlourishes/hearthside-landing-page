...
export function Services() {
  ...
  return (
    <section aria-labelledby="services-heading" className="py-10 bg-gradient-to-b from-white to-[#F9FAFB]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-10">
          <h2
            id="services-heading"
            className="font-serif text-2xl sm:text-3xl font-bold text-[#1F2937] mb-3 text-balance"
          >
            ...
            >
              ...
              <div className={`space-y-3 ${index % 2 === 1 ? "lg:order-1" : ""}`}>
                <h3
                  ...
                  className="font-serif text-xl sm:text-2xl font-bold text-[#1F2937] text-balance"
                >
                  {service.title}
                </h3>
                <p id={`service-${index}-description`} className="text-sm text-[#6B7280] leading-relaxed">
                  {service.description}
                </p>
                ...
                <Button asChild size="sm" className="bg-[#007B8C] hover:bg-[#006270] text-white px-5 rounded-xl">
                  <Link href={service.link} aria-label={`Learn more about ${service.title}`}>
                    Learn More
                  </Link>
                </Button>
              </div>
