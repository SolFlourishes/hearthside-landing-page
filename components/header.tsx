...
export function Header() {
  ...
  return (
    <header
      role="banner"
      className="sticky top-0 z-50 w-full border-b border-[#E5E7EB] dark:border-[#374151] bg-white/95 dark:bg-[#1F2937]/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 dark:supports-[backdrop-filter]:bg-[#1F2937]/80"
    >
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        ...
        {isMenuOpen && (
          <div id="mobile-menu" className="md:hidden py-4 border-t border-[#E5E7EB] dark:border-[#374151]">
