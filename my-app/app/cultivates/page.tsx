          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-[#6B7280] dark:text-[#9CA3AF] leading-relaxed text-center mb-12">
                At Hearthside Cultivates, we partner with organizations to create environments where every team member
                can flourish. Through workshops, training, and consulting, we help build the communication skills and
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="bg-white dark:bg-[#1F2937] rounded-xl p-8 shadow-sm border border-[#E5E7EB] dark:border-[#374151]">
                ...
                <p className="text-[#6B7280] dark:text-[#9CA3AF] leading-relaxed mb-4">
                  Strategic partnership to help your organization build a culture where everyone can thrive. We work
                  with leadership to identify barriers to effective communication and create actionable plans for
                  improvement.
                </p>
                <ul className="list-disc list-inside text-[#6B7280] dark:text-[#9CA3AF] space-y-2">
              ...
              <div className="bg-white dark:bg-[#1F2937] rounded-xl p-8 shadow-sm border border-[#E5E7EB] dark:border-[#374151]">
                ...
                <p className="text-[#6B7280] dark:text-[#9CA3AF] leading-relaxed mb-4">
                  Ongoing training programs that build lasting skills and create sustainable change. Our programs
                  combine workshops, coaching, and practical application to ensure real growth.
                </p>
                <ul className="list-disc list-inside text-[#6B7280] dark:text-[#9CA3AF] space-y-2">
