...
export function Hero() {
  return (
    <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#F9FAFB] via-[#FFF5F0] to-[#F9FAFB]">
        ...
        <div className="grid lg:grid-cols-2 gap-6 items-center">
          ...
          <div className="space-y-4 text-center lg:text-left">
            ...
            <div className="pt-4 border-t border-[#E5E7EB]">
              <p className="font-serif text-sm text-[#007B8C] italic">Hear Me, See Me, Know Me.</p>
            </div>
          </div>
          ...
          <div className="relative max-h-[400px]">
            ...
            <div className="absolute -bottom-3 -left-3 bg-white p-3 rounded-xl shadow-xl border border-[#E5E7EB] max-w-xs">
